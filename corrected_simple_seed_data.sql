-- Corrected Simple Seed Data for Marketing Pro Platform
...
-- Insert campaigns with valid types (email, social, whatsapp, sms, ads, mixed, content)
...
(1, 'حملة وسائل التواصل الاجتماعي', 'social', 'scheduled', date('now', '+3 days'), date('now', '+33 days'), 8000.00, 0.00, 'رجال الأعمال 25-50', '["الوصول إلى 10000 عميل محتمل"]', 2),
