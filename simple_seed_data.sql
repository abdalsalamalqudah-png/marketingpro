-- Simple Seed Data for Marketing Pro Platform - Essential Records Only
...
-- Insert campaigns with correct columns
INSERT INTO campaigns (team_id, name, type, status, start_date, end_date, budget, spent, target_audience, goals, created_by) VALUES
(1, 'حملة التوعية بالعلامة التجارية', 'awareness', 'active', date('now', '-7 days'), date('now', '+23 days'), 5000.00, 1200.50, 'الشباب 18-35', '["زيادة الوعي بالعلامة التجارية بنسبة 40%"]', 1),
(1, 'حملة الإطلاق الجديد', 'product_launch', 'scheduled', date('now', '+3 days'), date('now', '+33 days'), 8000.00, 0.00, 'رجال الأعمال 25-50', '["الوصول إلى 10000 عميل محتمل"]', 2),
(2, 'حملة نهاية العام', 'seasonal', 'draft', date('now', '+60 days'), date('now', '+90 days'), 12000.00, 0.00, 'العائلات والشباب', '["زيادة المبيعات بنسبة 60%"]', 1);